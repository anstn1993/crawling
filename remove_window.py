...
class RemoveWindow(QWidget):
    ...
    def setupUi(self, removeWindow):
        ...
        self.checkBoxGroup.setTitle('검색어 리스트')
        font = QtGui.QFont()
        ...
        self.description.setText("삭제할 검색어를 체크한 후 \'ok\'버튼을 누르세요")
        font = QtGui.QFont()
        font.setFamily("08서울남산체 L")
    ...
    def setCheckBoxList(self, vBox):#체크박스 셋
        for i in range(0, len(self.searchTextList)):
            checkBox = QtWidgets.QCheckBox(self.searchTextList[i][1], self.checkBoxGroup)
